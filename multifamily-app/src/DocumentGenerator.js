...
const DocumentGenerator = ({ setCurrentPage }) => {
  ...
  // Expanded sample defaults for auto-fill
  const sampleDefaults = {
    promissory_note: {
      borrower_name: 'John Doe',
      borrower_address: '123 Main St, Anytown, USA',
      borrower_entity_type: 'Individual',
      lender_name: 'Jane Smith',
      lender_address: '456 Oak Ave, Anytown, USA',
      lender_entity_type: 'Individual',
      ...
      maturity_date: '2055-08-01',
      security_type: 'Real Property',
      secured_property_address: '789 Elm St, Anytown, USA'
    },
    operating_agreement: {
      company_name: 'Sample LLC',
      formation_state: 'Delaware',
      formation_date: '2025-08-01',
      business_address: '123 Business St, Anytown, USA',
      registered_agent_name: 'John Doe',
      registered_agent_address: '123 Agent St, Anytown, USA',
      member1_name: 'John Doe',
      member1_type: 'Individual',
      member1_percentage: '50',
      member1_contribution: '50000',
      member2_name: 'Jane Smith',
      member2_type: 'Individual',
      member2_percentage: '50',
      member2_contribution: '50000',
      manager_name: 'John Doe',
      management_type: 'Member-Managed',
      voting_threshold: '51',
      additional_contributions_required: 'By Unanimous Consent',
      governing_state: 'Delaware',
      arbitration_location: 'Anytown, USA'
    },
    equity_buyout: {
      buyer_name: 'Acquiring Member',
      buyer_address: '123 Buy St, Anytown, USA',
      buyer_email: 'buyer@example.com',
      buyer_phone: '555-1234',
      seller_name: 'Departing Member',
      seller_address: '456 Sell St, Anytown, USA',
      seller_email: 'seller@example.com',
      seller_phone: '555-5678',
      ...
      formation_state: 'Delaware',
      member2_percentage: '30',
      governing_state: 'Delaware'
    },
    partnership_agreement: {
      buyer_name: 'General Partner',
      seller_name: 'Limited Partner',
      company_name: 'Sample Partnership',
      formation_state: 'Texas',
      business_address: '123 Partner St, Anytown, USA',
      property_address: '789 Property St, Anytown, USA',
      member1_percentage: '50.1',
      member2_percentage: '49.9',
      member2_contribution: '49000',
      voting_threshold: '75',
      governing_state: 'Texas',
      arbitration_location: 'Anytown, Texas'
    },
    purchase_contract: {
      property_address: '123 Property St, Anytown, USA',
      legal_description: 'Lot 1, Block 2, Sample Subdivision',
      apn: '123-456-789',
      buyer_name: 'Buyer Name',
      buyer_address: '456 Buy St, Anytown, USA',
      buyer_email: 'buyer@example.com',
      buyer_phone: '555-1234',
      seller_name: 'Seller Name',
      seller_address: '789 Sell St, Anytown, USA',
      seller_email: 'seller@example.com',
      seller_phone: '555-5678',
      ...
      escrow_company: 'Sample Escrow',
      title_company: 'Sample Title',
      governing_state: 'California'
    },
    loi: {
      property_address: '123 Intent St, Anytown, USA',
      seller_name: 'Seller Name',
      seller_address: '456 Sell St, Anytown, USA',
      seller_email: 'seller@example.com',
      seller_phone: '555-5678',
      buyer_name: 'Buyer Name',
      buyer_address: '789 Buy St, Anytown, USA',
      buyer_email: 'buyer@example.com',
      buyer_phone: '555-1234',
      purchase_price: '500000',
      earnest_money: '10000',
      ...
      financing_type: 'Cash',
      appraisal_contingency: 'No',
      closing_date: '2025-11-01'
    }
  };

  const autoFillSamples = () => {
    const defaults = sampleDefaults[selectedDocument] || {};
    setBasicInfo(defaults);
    setValidationErrors({});
  };
...
10. ACCEPTANCE
This offer shall expire if not accepted by _______ on on _______, 20__.
BUYER:
_________________________________
...
Date: _______________`;
  ...
  const generatePDF = () => {
    ...
    printWindow.document.write('<html><head><title>Document</title></head><body>');
    printWindow.document.write('<pre>' + finalDocument + '</pre>');
        ...
        <div style={styles.mainContent}>
          ...
          <div style={styles.formContainer}>
            ...
            <button
              ...
              style={{...styles.button, ...styles.buttonSecondary, marginBottom: '24px'}}
            >
